      ...
      <section id="collections-grid" className="py-20 bg-cream">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="font-heading italic text-sm text-muted-foreground mt-2">Khám phá vẻ đẹp tinh tế từ những thiết kế độc đáo</p>
            <p className="font-heading italic text-xs text-muted-foreground mt-1">Chế tác thủ công từ nguyên liệu cao cấp hàng đầu</p>
          </div>
